...
- Every channel message wakes every idle non-human member in its resolved audience except its author, regardless of who authored it. A wake does not imply a reply, but **who wrote the message decides the default**, and the two directions pull opposite ways:
