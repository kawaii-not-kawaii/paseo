  ...
  team: {
    ...
    members: {
      ...
      list: {
        ...
        homeWorkspace: "مساحة العمل الأساسية: {{workspace}}",
      ...
      actions: {
        unavailableTitle: "لا يمكن لهذا العضو التشغيل بعد",
        workspaceUnavailable:
          "مساحة العمل الأساسية {{workspace}} غير متاحة. أعد توجيه هذا العضو قبل تشغيله.",
        workspaceMissingReason:
          "فقد هذا العضو مساحة العمل الأساسية الخاصة به. أعد توجيهه قبل تشغيله.",
        repoint: "أعد توجيه مساحة العمل",
        create: "عضو جديد",
        start: "ابدأ",
        stop: "أوقف",
        remove: "إزالة",
        ...
        removeMessage:
          "سيتم الاحتفاظ بالسجل وستبقى الرسائل الحالية منسوبة إلى صاحبها بعد الإزالة. هل تريد إزالة {{name}} من هذا المشروع؟",
        removeConfirm: "إزالة",
      },
      form: {
        ...
        runtimeAndModel: "البيئة والنموذج",
        mode: "الوضع",
        modePlaceholder: "اختر وضعًا",
        noModes: "لا توجد أوضاع متاحة",
        rolePrompt: "موجّه الدور",
        assignments: "تعيينات المشروع",
        currentProject: "المشروع الحالي",
        homeWorkspace: "مساحة العمل الأساسية",
    ...
    tasks: {
      ...
      blockedBy: "محجوبة بواسطة {{refs}}",
      handbacks: "{{count}} إعادات",
      views: {
        board: "لوحة",
        list: "قائمة",
      },
      ...
      claim: {
        unassigned: "غير مسند",
        none: "لا يوجد مطالب",
        distinct: "المطالب مختلف عن المسند إليه",
      },
      references: {
        channel: "قناة",
        member: "عضو",
        deleted: "لم يعد هذا المرجع يشير إلى سجل موجود.",
      },
      detail: {
        title: "تفاصيل المهمة",
        titleLabel: "العنوان",
    ...
    settings: {
      ...
      retentionPrunedTitle: "تم تقليم السجل عند بدء التشغيل",
      retentionPrunedBody: "أزال الخادم أقدم {{count}} رسالة لتطبيق هذا الحد.",
      adoption: {
      ...
      recovery: {
        title: "تحتاج بيانات الفريق إلى استعادة",
        body: "تعذر قراءة قاعدة بيانات Team الخاصة بهذا المشروع. استعد أحدث لقطة تلقائية لاسترجاع القنوات والرسائل والمهام.",
        restoreAction: "استعادة اللقطة",
        restoringAction: "جارٍ الاستعادة...",
        failedTitle: "فشلت الاستعادة",
      },
    },
  },
  agentList: {
