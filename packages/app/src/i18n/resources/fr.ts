...
export const fr: TranslationResources = {
  ...
  team: {
    ...
    project: {
      none: "Aucun projet disponible sur ce daemon",
    },
    sections: {
      chat: "Chat",
      members: "Membres",
    ...
    chat: {
      ...
      messages: "Messages",
      compose: "Rédiger",
      emptyChannels: "Aucun canal pour le moment",
      emptyMessages: "Aucun message pour le moment",
      loadOlder: "Charger les messages plus anciens",
      placeholder: "Publiez dans ce canal et mentionnez des @membres",
      send: "Envoyer",
      sent: "Envoyé",
      sending: "Envoi...",
      noMentions: "Aucun membre ne correspond à cette mention",
      channel: {
        new: "Nouveau canal",
    ...
    members: {
      ...
      list: {
        ...
        homeWorkspace: "Espace de travail principal : {{workspace}}",
      ...
      actions: {
        unavailableTitle: "Ce membre ne peut pas encore s’exécuter",
        workspaceUnavailable:
          "L’espace de travail principal {{workspace}} est indisponible. Reconfigurez ce membre avant de le démarrer.",
        workspaceMissingReason:
          "Ce membre a perdu son espace de travail principal. Reconfigurez-le avant de le démarrer.",
        repoint: "Reconfigurer l’espace de travail",
        ...
        removeMessage:
          "L’historique est conservé et les messages existants gardent leur attribution après le retrait. Retirer {{name}} de ce projet ?",
        removeConfirm: "Retirer",
      },
      form: {
        blockedName: "Ajoutez un nom.",
        ...
        runtimeAndModel: "Runtime et modèle",
        mode: "Mode",
        modePlaceholder: "Choisissez un mode",
        noModes: "Aucun mode disponible",
        rolePrompt: "Prompt de rôle",
        assignments: "Affectations de projet",
        currentProject: "Projet actuel",
        homeWorkspace: "Espace de travail principal",
      ...
      proposals: {
        empty: "Aucun membre proposé",
        confirm: "Relire et créer",
      },
    },
    tasks: {
      ...
      blockedBy: "Bloquée par {{refs}}",
      handbacks: "{{count}} retours",
      views: {
        board: "Tableau",
        list: "Liste",
      },
      ...
      claim: {
        ...
        none: "Aucun détenteur",
        distinct: "Le détenteur diffère de l'attributaire",
      },
      references: {
        channel: "Canal",
        member: "Membre",
        deleted: "Cette référence ne pointe plus vers un enregistrement existant.",
      },
      detail: {
