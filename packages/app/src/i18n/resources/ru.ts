  ...
  team: {
    ...
    members: {
      ...
      list: {
        ...
        homeWorkspace: "Домашний workspace: {{workspace}}",
        channels: "Каналы: {{channels}}",
      },
      detail: {
        channelsAll: "Все каналы этого проекта",
        channelsHelp:
          "Членство в каналах пока не отделено: любого участника этого проекта можно упомянуть в любом его канале.",
        ...
        emptyFile: "Этот файл пуст.",
      },
      actions: {
        unavailableTitle: "Этот участник пока не может запускаться",
        workspaceUnavailable:
          "Домашний workspace {{workspace}} недоступен. Переназначьте его перед запуском.",
        workspaceMissingReason:
          "Этот участник потерял домашний workspace. Переназначьте его перед запуском.",
        repoint: "Переназначить workspace",
        ...
        removeMessage:
          "История сохраняется, а существующие сообщения сохраняют авторство после удаления. Удалить {{name}} из этого проекта?",
      ...
      form: {
        ...
        runtimeAndModel: "Runtime и модель",
        mode: "Режим",
        modePlaceholder: "Выберите режим",
        noModes: "Нет доступных режимов",
        rolePrompt: "Ролевой промпт",
        assignments: "Назначения проекта",
        currentProject: "Текущий проект",
        homeWorkspace: "Домашний workspace",
      ...
      proposals: {
        empty: "Нет предложенных участников",
        confirm: "Проверить и создать",
      },
    },
    tasks: {
      ...
      moveTo: "Переместить в {{status}}",
      blockedBy: "Заблокирована: {{refs}}",
      handbacks: "{{count}} возвратов",
      views: {
        board: "Доска",
        list: "Список",
      },
      ...
      claim: {
        ...
        none: "Никто не держит",
        distinct: "Держатель отличается от исполнителя",
      },
      references: {
        channel: "Канал",
        member: "Участник",
        deleted: "Эта ссылка больше не указывает на существующую запись.",
      },
      detail: {
        title: "Детали задачи",
        titleLabel: "Название",
    ...
    settings: {
      ...
      retentionPrunedTitle: "История была очищена при запуске",
      retentionPrunedBody:
        "Демон удалил {{count}} самых старых сообщений, чтобы применить этот лимит.",
      adoption: {
      ...
      recovery: {
        title: "Данные команды требуют восстановления",
        body: "Не удалось прочитать базу данных Team для этого проекта. Восстановите последний автоматический снимок, чтобы вернуть каналы, сообщения и задачи.",
        restoreAction: "Восстановить снимок",
