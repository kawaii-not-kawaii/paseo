  ...
  team: {
    ...
    members: {
      ...
      list: {
        ...
        homeWorkspace: "Workspace principal: {{workspace}}",
        channels: "Canais: {{channels}}",
      },
      detail: {
        channelsAll: "Todos os canais deste projeto",
        channelsHelp:
          "A participação em canais ainda não é separada — qualquer membro deste projeto pode ser mencionado em qualquer um dos seus canais.",
        ...
        emptyFile: "Este arquivo está vazio.",
      },
      actions: {
        unavailableTitle: "Este membro ainda não pode rodar",
        workspaceUnavailable:
          "O workspace principal {{workspace}} está indisponível. Redirecione este membro antes de iniciá-lo.",
        workspaceMissingReason:
          "Este membro perdeu o workspace principal. Redirecione-o antes de iniciá-lo.",
        repoint: "Redirecionar workspace",
        create: "Novo membro",
        start: "Iniciar",
        stop: "Parar",
        remove: "Remover",
        ...
        removeMessage:
          "O histórico é preservado e as mensagens existentes mantêm a atribuição após a remoção. Remover {{name}} deste projeto?",
      ...
      form: {
        ...
        blockedNoWorkspaces: "{{project}} ainda não tem workspaces. Crie um abaixo.",
        ...
        runtimeAndModel: "Runtime e modelo",
        mode: "Modo",
        modePlaceholder: "Escolha um modo",
        noModes: "Nenhum modo disponível",
        rolePrompt: "Prompt de papel",
        assignments: "Atribuições de projeto",
        currentProject: "Projeto atual",
        homeWorkspace: "Workspace principal",
        workspacePlaceholder: "Escolha um workspace",
        noWorkspaces: "Nenhum workspace disponível",
        workspaceRequired: "Escolha um workspace principal antes de salvar.",
        createWorkspace: "Criar um workspace",
        workspaceCreateFailed: "Não foi possível criar o workspace.",
        create: "Criar membro",
      },
      proposals: {
        empty: "Nenhum membro proposto",
        confirm: "Revisar e criar",
      },
    },
    tasks: {
      ...
      claim: {
        ...
        none: "Sem detentor",
        distinct: "O detentor difere do responsável",
      },
      references: {
        channel: "Canal",
        member: "Membro",
        deleted: "Esta referência não aponta mais para um registro existente.",
      },
      detail: {
