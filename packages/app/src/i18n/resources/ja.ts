  ...
  team: {
    ...
    members: {
      ...
      list: {
        ...
        homeWorkspace: "ホームワークスペース: {{workspace}}",
      ...
      actions: {
        unavailableTitle: "このメンバーはまだ実行できません",
        workspaceUnavailable:
          "ホームワークスペース {{workspace}} は利用できません。開始する前にこのメンバーの向き先を更新してください。",
        workspaceMissingReason:
          "このメンバーはホームワークスペースを失いました。開始する前に向き先を更新してください。",
        repoint: "ワークスペースを再指定",
        create: "新しいメンバー",
        start: "開始",
        stop: "停止",
        ...
        removeMessage:
          "削除後も履歴は保持され、既存メッセージの帰属も維持されます。{{name}} をこのプロジェクトから削除しますか？",
        removeConfirm: "削除",
      },
      form: {
        createTitle: "メンバーを作成",
    ...
    tasks: {
      ...
      drag: "タスクをドラッグ",
      moveTo: "{{status}}へ移動",
      blockedBy: "{{refs}} によってブロック中",
      handbacks: "差し戻し {{count}} 回",
      views: {
        board: "ボード",
        list: "リスト",
      },
      ...
      claim: {
        unassigned: "未割り当て",
        none: "クレイマなし",
        distinct: "クレイマと担当者が異なります",
      },
      references: {
        channel: "チャンネル",
        member: "メンバー",
        deleted: "この参照は既存の記録を指していません。",
      },
      detail: {
        title: "タスク詳細",
        titleLabel: "タイトル",
