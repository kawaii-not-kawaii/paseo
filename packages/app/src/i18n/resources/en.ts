  ...
  team: {
    ...
    members: {
      ...
      list: {
        ...
        homeWorkspace: "Home workspace: {{workspace}}",
      ...
      actions: {
        unavailableTitle: "This member cannot run yet",
        workspaceUnavailable:
          "Home workspace {{workspace}} is unavailable. Re-point this member before starting it.",
        workspaceMissingReason:
          "This member lost its home workspace. Re-point it before starting it.",
        repoint: "Re-point workspace",
        create: "New member",
        start: "Start",
        stop: "Stop",
        remove: "Remove",
        ...
        removeMessage:
          "History is preserved and existing messages keep their attribution after removal. Remove {{name}} from this project?",
      ...
      form: {
        ...
        runtimeAndModel: "Runtime and model",
        mode: "Mode",
    ...
    tasks: {
      ...
      blockedBy: "Blocked by {{refs}}",
      handbacks: "{{count}} handbacks",
      views: {
        board: "Board",
        list: "List",
      },
      ...
      claim: {
        ...
        none: "No claimant",
        distinct: "Claimant differs from assignee",
      },
      references: {
        channel: "Channel",
        member: "Member",
        deleted: "This reference no longer points to an existing record.",
      },
      detail: {
        title: "Task detail",
        titleLabel: "Title",
