  ...
  team: {
    ...
    chat: {
      ...
      channel: {
        ...
        delete: "删除频道",
        deleteTitle: "删除 #{{name}}？",
        deleteMessage: "删除 #{{name}} 会永久删除其中的所有消息。此操作无法撤销。",
        deleteConfirm: "删除频道",
        unableToDelete: "无法删除该频道。",
        nameExists: "名为“{{name}}”的频道已存在。",
      },
    },
    members: {
      idle: "空闲",
      ...
      actions: {
        unavailableTitle: "此成员暂时无法运行",
        workspaceUnavailable: "主工作区 {{workspace}} 不可用。启动前请先重新指向该成员的工作区。",
        workspaceMissingReason: "此成员已失去主工作区。启动前请先重新指向它的工作区。",
        repoint: "重新指向工作区",
        create: "新建成员",
        start: "启动",
        stop: "停止",
        ...
        removeTitle: "移除 {{name}}？",
        removeMessage:
          "移除后历史会保留，现有消息仍会保留原有归属。要将 {{name}} 从此项目中移除吗？",
        removeConfirm: "移除",
      },
      form: {
        createTitle: "创建成员",
    ...
    settings: {
      ...
      retentionPrunedTitle: "启动时已清理历史记录",
      retentionPrunedBody: "守护进程已删除最旧的 {{count}} 条消息以执行此上限。",
      adoption: {
        title: "接管现有聊天历史",
      ...
      recovery: {
        title: "Team 数据需要恢复",
        body: "无法读取此项目的 Team 数据库。恢复最近一次自动快照即可找回频道、消息和任务。",
        restoreAction: "恢复快照",
        restoringAction: "恢复中...",
        failedTitle: "恢复失败",
      },
