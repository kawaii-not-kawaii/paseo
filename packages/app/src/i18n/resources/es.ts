...
export const es: TranslationResources = {
  ...
  team: {
    ...
    chat: {
      ...
      memberWorking: "{{member}} está trabajando",
      ...
      channel: {
        ...
        create: "Crear canal",
        manage: "Gestionar canal",
        edit: "Editar canal",
        editTitle: "Editar canal",
        delete: "Eliminar canal",
        deleteTitle: "¿Eliminar #{{name}}?",
        deleteMessage:
          "Eliminar #{{name}} borra permanentemente todos sus mensajes. Esta acción no se puede deshacer.",
        deleteConfirm: "Eliminar canal",
        unableToDelete: "No se pudo eliminar el canal.",
        nameExists: "Ya existe un canal llamado «{{name}}».",
      },
    },
    members: {
      ...
      list: {
        ...
        homeWorkspace: "Workspace base: {{workspace}}",
      ...
      actions: {
        unavailableTitle: "Este miembro todavía no puede ejecutarse",
        workspaceUnavailable:
          "El workspace base {{workspace}} no está disponible. Vuelve a apuntar este miembro antes de iniciarlo.",
        workspaceMissingReason:
          "Este miembro perdió su workspace base. Vuelve a apuntarlo antes de iniciarlo.",
        repoint: "Reapuntar workspace",
        ...
        removeMessage:
          "El historial se conserva y los mensajes existentes mantienen su atribución después de quitarlo. ¿Quitar a {{name}} de este proyecto?",
      ...
      form: {
        ...
        blockedNoWorkspaces: "{{project}} todavía no tiene espacios de trabajo. Crea uno abajo.",
        ...
        runtimeAndModel: "Runtime y modelo",
        mode: "Modo",
        modePlaceholder: "Elige un modo",
        noModes: "No hay modos disponibles",
        rolePrompt: "Prompt de rol",
        assignments: "Asignaciones de proyecto",
        currentProject: "Proyecto actual",
        homeWorkspace: "Workspace base",
        workspacePlaceholder: "Elige un workspace",
        noWorkspaces: "No hay workspaces disponibles",
        workspaceRequired: "Elige un workspace base antes de guardar.",
        createWorkspace: "Crear un espacio de trabajo",
        workspaceCreateFailed: "No se pudo crear el espacio de trabajo.",
        create: "Crear miembro",
      },
      proposals: {
        empty: "No hay miembros propuestos",
    ...
    tasks: {
      ...
      blockedBy: "Bloqueada por {{refs}}",
      handbacks: "{{count}} devoluciones",
      views: {
        board: "Tablero",
        list: "Lista",
      },
      ...
      claim: {
        ...
        none: "Sin reclamante",
        distinct: "El reclamante es distinto del asignado",
      },
      references: {
        channel: "Canal",
        member: "Miembro",
        deleted: "Esta referencia ya no apunta a un registro existente.",
      },
      detail: {
